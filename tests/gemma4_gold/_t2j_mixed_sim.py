...
_log = open(r"C:\Users\Knack\AppData\Local\Temp\_t2j_mixed.log", "a", buffering=1, encoding="utf-8")
...
print(f"MIXED Q4B+Q8 SIM: PPL = {ppl:.4f} vs gold {ORACLE} -> {rel*100:+.2f}%  [{time.time()-t0:.0f}s]", flush=True)
