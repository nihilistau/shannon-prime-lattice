...
tags: [telepathy, answer-labeled, honest-negative, task-answering-fails, delegate-capability-bottleneck, metric-gaming, strict-eval, TELE-11, boundary, episode, tier-1]
mem_tier: summary
mem_full: ae44d0be6aebc659
---

# TELE-11 honest negative: answer-fidelity fails (strict 0.000); bridge transmits, can't confer answering on 0.5B

answer_dataset.py (correct-by-construction Q->A) + train_answer_adapter.py + strict_eval.py. Lenient 0.321 vs STRICT 0.000 vs degenerate 0.302. Lesson: inspect samples; lenient gates get gamed by degenerate repetition. Path: bridge=faithful transport (proven); answering needs a capable delegate. Native deploy (d) remains valid for the PROVEN transmission capability.

Full context: [full/ae44d0be6aebc659.md](../full/ae44d0be6aebc659.md)
