...
tags: [G-OBEY-PROBE-OFFLINE, obey probe, linear probe, final norm convicted, treatment signature, mode confound, do not retry linear probe final-norm, run P plain capture, agent, tier-2]
mem_tier: full
---
