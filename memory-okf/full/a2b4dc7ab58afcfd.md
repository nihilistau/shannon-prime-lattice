...
tags: [telepathy, hybrid, fused-fails, sequential, decide-via-latent-execute-via-text, two-stage, route-head, TELE-12, architecture-validated, capstone, episode, tier-2]
mem_tier: full
---

BLOB POINTER (Tier-2 = external payload)

blob: tele12:a2b4dc7ab58afcfd
kind: episode
