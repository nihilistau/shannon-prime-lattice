...
| 9f7e57fc33207731 | agent | powershell,windows,cwd,IO.File,ReadAllText,WriteAllText,absolute path,gotcha,edit,rust | PowerShell cd does NOT change .NET process CWD; [IO.File]::ReadAllText/WriteAllText with relative paths hit C:\Users\Knack and silently fail. Always use absolute paths for .NET IO. | GREEN | sum/9f7e57fc33207731.md |
| e0f6c4a4d929135f | agent | nightshift,curator,build,cargo,features,kairos,wire_cuda_backend,_curator_build.bat,run_kairos_curator,SP_NIGHTSHIFT_OFFLINE | Build run_kairos_curator with BOTH features: cargo build --release --features 'wire_cuda_backend kairos' --target-dir target-wirecuda --bin sp-daemon (env-cuda.bat + LIBCLANG_PATH first). _curator_build.bat -> _curator_build.log. | DESIGN | sum/e0f6c4a4d929135f.md |
| c2sig_80c4adf6cc245e715359ac5c65519dd95c6eb3124f4f1e2bd260c15af73d3fd3 | episode | The primary access code for the KAI-3 subterranean vault is | The primary access code for the KAI-3 subterranean vault is | ACTIVE | sum/c2sig_80c4adf6cc245e715359ac5c65519dd95c6eb3124f4f1e2bd260c15af73d3fd3.md |
| e07cdad67ac5869a | agent | nightshift,curator,G-NIGHTSHIFT-CURATOR,GREEN,extractor,ep.secret,ablation,admit,model-call,_curator_gate.bat | Offline curator GREEN: 12B extracts ep.secret -> ablation admit (TAU=-8) -> MEM-OKF emit. novel -33.59 ACCEPT / param 0.00 REJECT. Model-call extractor was the fix vs token-rarity. engine 6107f3e. Criteria 1-4 GREEN, 5 (live) pending. | GREEN | sum/e07cdad67ac5869a.md |
| 3ad6593ffa5b9d16 | agent | W_c,memorizer,OOD,generalization,holdout,recall,nightshift,stage-2,diffusion judge,kill-test,G-DIFFJUDGE-OOD-H2H | W_c memorizes (99.7% trained / 11.1% full-reg OOD / K8=28.3% bounded OOD). NIGHTSHIFT new episodes are OOD for it -> need zero-shot Stage-2 (diffusion/ablation). Kill-test pre-registered, diffusion PENDING. | GREEN | sum/3ad6593ffa5b9d16.md |
| 42b4e2989a12628d | agent | diffjudge,G-DIFFJUDGE-OOD-H2H,invalid,false-positive,embeddings required,llama-diffusion-cli,run-health,artifact,re-run,verify output | Diffusion oracle malfunctioned (all replies = 'embeddings required' warning, ZERO tags); harness printed 94.4% GATE GREEN = ARTIFACT. Run-health caveat caught a false positive. Fix oracle invocation + confirm tags before any verdict. W_c floor 28.3% stands; fork OPEN. | RED | sum/42b4e2989a12628d.md |
