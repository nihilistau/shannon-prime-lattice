...
sp_status: DESIGN
sp_gate: G-INT-1 (HOT persistence: f32 payload byte-identical + C2 sig Hamming 0) · G-INT-2 (bounded-N causal recall; ≥80% novel / 100% foreign-reject) · G-INT-3 (KAIROS ring governance) — all pre-registered below, default-off = null floor
