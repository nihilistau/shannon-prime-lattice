...
**STAGE B — REMAINING: B2 XBAR ring/recall → B3 ARM → B4 NIGHTSHIFT, per §3. Each registers any new session knob in `sp_l1.h`/`PPT-LAT-L1-ABI-v0.md` first, then builds + gates.**
