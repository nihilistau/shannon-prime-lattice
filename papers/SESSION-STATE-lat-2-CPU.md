...
4. **2-CU** (§8.3) — only after the above. Host reality: **CUDA 13.2 + RTX 2060 sm_75** (not the old 12.4 pin); `env-cuda.bat`→13.2 (+ likely the ASCII/goto fix).
