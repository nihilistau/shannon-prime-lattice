...
## 5.14 XBAR — THE AUDITABLE LATENT CROSSBAR (RFC v1.1; P1 CITABLE, P2.b Fork-2 recall WORKS, C1-lite COMPLETE) (2026-06-09; refreshed 2026-06-10)
...
- **NEXT:** k-sweep verdict (k=6 control) → pin the k/λ operating point → Fork-1 capacity arm (adapter width/depth/data) if adapter-limited · P3 ring-on-gemma4-CUDA (G-P3-GEOM + G-P3-SHARED) · #115 tokenizer dispatch · NIGHTSHIFT v0 (schtasks over the C1-lite loop).
