...
## 5.14 XBAR — THE AUDITABLE LATENT CROSSBAR (RFC v1.1; P1 CITABLE · P2.b CLOSED · P3 READ-PATH COMPLETE — P3.1/P3.1b-1/P3.1b-2 all BIT-EXACT on the 12B · P3.2 WRITE-PATH: spill BYTE-EXACT (G-P3-R2.a, 0 sharer blocks) + paged-read BIT-EXACT (G-P3-R2.b-1, history off disk + live source POISONED, diffs=0)) (2026-06-09; refreshed 2026-06-12)
