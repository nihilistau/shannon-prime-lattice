...
- **NEXT:** 3-seed λ=0.5-vs-0.25 confirm at the pinned k=2 → Fork-1 capacity arm (adapter width/depth/data; contrastive term if it plateaus) · P3 ring-on-gemma4-CUDA (G-P3-GEOM + G-P3-SHARED) · #115 tokenizer dispatch · NIGHTSHIFT v0 (schtasks over the C1-lite loop).
