...
- **Stage Eta OPENED (2026-06-06)** — the Gemma4-CUDA forward+decode port (branch `stage-eta-gemma4-cuda`), so the 6.6 GB Gemma-4-12B-Q4_K_M runs on the 2060 at the proven ~7× Q4 win. CPU `gemma4.c` is the bit-exact oracle; 6-stage gated plan banked. Resume at ETA.1.
